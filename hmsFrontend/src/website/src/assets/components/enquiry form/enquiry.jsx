...
const EnquiryForm = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/Images/enquirybg.jpg')",
    ...
    >
      ...
      <div className="bg-white p-6 md:p-10 rounded-2xl shadow-lg w-full md:w-1/2 bg-opacity-90 mx-auto md:mx-0">
        <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900">Enquiry Form</h2>
        <form className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block font-medium text-gray-800 mb-1">Name*</label>
              <input type="text" placeholder="Enter your Name" className="w-full border-b border-gray-400 p-2 focus:outline-none focus:border-black" />
            </div>
            <div>
              <label className="block font-medium text-gray-800 mb-1">E-mail*</label>
              <input type="email" placeholder="Enter your E-mail" className="w-full border-b border-gray-400 p-2 focus:outline-none focus:border-black" />
            </div>
            <div>
              <label className="block font-medium text-gray-800 mb-1">Mobile No.*</label>
              <input type="tel" placeholder="Enter your mobile number" className="w-full border-b border-gray-400 p-2 focus:outline-none focus:border-black" />
            </div>
            <div>
              <label className="block font-medium text-gray-800 mb-1">City*</label>
              <input type="text" placeholder="Enter your city" className="w-full border-b border-gray-400 p-2 focus:outline-none focus:border-black" />
            </div>
          </div>
          <div>
            <label className="block font-medium text-gray-800 mb-1">Your Message*</label>
            <textarea placeholder="Enter your message here" className="w-full border-b border-gray-400 p-2 focus:outline-none focus:border-black" rows="2"></textarea>
          </div>
